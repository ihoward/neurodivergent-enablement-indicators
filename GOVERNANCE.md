...
Maintainers are appointed by atypical. The list of current maintainers is in [`docs/framework.md`](docs/framework.md).
...
3. If unresolved, the matter is escalated to atypical for final determination.
...
*Maintained by [atypical](https://atypical.business)*
